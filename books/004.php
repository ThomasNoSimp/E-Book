...
<head>
    ...
    <title>E-Book | MoeSatLinnHtet_Kywe</title>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-lg-12 mx-auto">
                <div class="content">
                    <h2 class="center-content book-title" name="book-title">MoeSatLinnHtet_Kywe</h2>
                    <img data-key="image" src="../src/Books/Book-Images/MoeSatLinnHtet_Kywe.jpeg" alt="Book Cover" class="img-fluid center-block">
                    <!-- Description Content -->
                    <p description="book-title" class="center-content"><strong>Book Title: </strong>MoeSatLinnHtet_Kywe</p>
                    <p description="book-author" class="center-content"><strong>Book Author: </strong>MoeSatLinnHtet</p>
                    <!-- Buttons -->
                    ...
                    <script type="text/javascript" defer>
                        $(document).ready(function(){
                            ...
                            $('#downloadBtn').on('click', function() {
                                ...
                                var url = '../src/Books/MoeSatLinnHtet_Kywe.pdf';
                                ...
                                .then(blob => {
                                    ...
                                    link.href = blobUrl;
                                    link.download = 'MoeSatLinnHtet_Kywe.pdf'; // Specify the filename for download
